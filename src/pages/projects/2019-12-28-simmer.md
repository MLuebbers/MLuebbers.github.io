...
<div style="display:flex; flex-direction: row; justify-content: space-between;">
    <img style="width: 20%;" src="../../media/mockups/wireframe1.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe2.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe3.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe4.png"/>
</div>
...
<div style="display:flex; flex-direction: row; justify-content: space-between;">
    <img style="width: 20%;" src="../../media/mockups/wireframe1-b.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe2-b.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe3-b.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe4-b.png"/>
</div>
<div class="spacer"></div>
...
<div style="display:flex; flex-direction: row; justify-content: space-between;">
    <img style="width: 20%;" src="../../media/mockups/wireframe1-c.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe2-c.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe3-c.png"/>
    <img style="width: 20%;" src="../../media/mockups/wireframe4-c.png"/>
</div>
