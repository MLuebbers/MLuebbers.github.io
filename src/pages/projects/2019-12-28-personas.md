---
title: User Research for the CIT Elevators
subtitle: Personas
tags: ['personas', 'UI', 'UX']
---
...
<table style="width:100%; margin: auto;">
    <tr> 
        <td> 
            <h1>Thinks</h1>
            <ul>
                <li><i>If I am late, at least I won't be the only one.</i></li>
                <li><i>Are people going to wait, or take the stairs?</i></li>
                <li><i>Does some one here have swipe access to my floor?</i></li>
            </ul>
        </td>
        <td>
            <h1>Feels</h1>
            <ul>
                <li>Safer taking the path with more people.</li>
                <li>Not in a rush to get to their destination.</li>
                <li>Uncertain when waiting for the elevator by themself.</li>
                <li>Nervous to find out if they have swipe access to their destination.</li>
            </ul>
        </td>
    </tr>
    <tr> 
        <td> 
            <h1>Says</h1>
            <ul>
                <li>“Are you guys going to wait for the elevator?”</li>
                <li>“Well, I am okay with either.” (When asked which they prefer)</li>
                <li>“I’ll take the stairs with you.”</li>
            </ul>
        </td>
        <td>
            <h1>Does</h1>
            <ul>
                <li>Waits to see what the group does.</li>
                <li>Does not stand in front of the group. Instead waits behind others.</li>
                <li>Follows the crowd if they decide to take the stairs.</li>
                <li>Lets others swipe their card on the elevator.</li>
            </ul>
        </td>
    </tr>
</table>
...
<table style="width:100%; margin: auto;">
    <tr> 
        <td> 
            <h1>Thinks</h1>
            <ul>
                <li><i>This elevator will come down first/be faster.</i></li>
                <li><i>Maybe I have time to use the bathroom before the elevator gets here.</i></li>
                <li><i>I hope this elevator does not stop on the 2nd floor (while trying to go to 5th in a full elevator).</i></li>
            </ul>
        </td>
        <td>
            <h1>Feels</h1>
            <ul>
                <li>Tricked when the buttons do not light up after their swipe.</li>
                <li>Anxious when neither elevator is coming down after a long time.</li>
                <li>Frustrated when the elevator makes multiple unnecessary stops.</li>
            </ul>
        </td>
    </tr>
    <tr> 
        <td> 
            <h1>Says</h1>
            <ul>
                <li>“Wow, there’s so many people in here.”</li>
                <li>“Ugh...” (when elevator stops at 2nd floor and nobody gets on)</li>
                <li>“Let’s just take the stairs.”, “Wanna just take the stairs?” (when elevator stops at 3rd floor)</li>
            </ul>
        </td>
        <td>
            <h1>Does</h1>
            <ul>
                <li>Looks back and forth between both elevators and quickly approaches the one that will come first once they are confident.</li>
                <li>Exits the elevator before their stop if it makes too many of them.</li>
                <li>Runs into a crowded elevator because it would take too long if they waited for the next one.</li>
            </ul>
        </td>
    </tr>
</table>
...
<img style="mix-blend-mode: darken;" src="../../media/storyboard.png"/>
